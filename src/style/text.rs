...
///
/// ```rust
/// use teapot::style::{Style, Color, Position, BorderStyle};
///
/// let style = Style::new()
...
impl Style {
    ...
    /// Set the foreground color (alias for `foreground`).
    ...
    /// Set the background color (alias for `background`).
...
mod tests {
    ...
    #[test]
    fn test_inherit() {
        let parent = Style::new().foreground(Color::Red).bold(true);
